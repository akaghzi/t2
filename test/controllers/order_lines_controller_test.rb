...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { order_id: @order_line.order_id, price: @order_line.price, product_id: @order_line.product_id, quantity: @order_line.quantity }
    end
  ...
  test "should update order_line" do
    patch :update, id: @order_line, order_line: { order_id: @order_line.order_id, price: @order_line.price, product_id: @order_line.product_id, quantity: @order_line.quantity }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
